...
describe "StaticPages" do
  ...
  describe "Home page" do
    ...
    describe "for signed-in users" do
      ...
      before do
        FactoryGirl.create(:micropost, user: user, content: "Hunting for diamonds")
        FactoryGirl.create(:micropost, user: user, content: "Mfw creepers instead")
        sign_in user
        visit root_path
      end
  ...
  describe "Directions page" do
    before { visit directions_path }
    let(:heading)   { 'Directions' }
    let(:page_title){ 'Directions' }
